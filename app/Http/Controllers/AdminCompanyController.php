...
class AdminCompanyController extends Controller
{
    ...
    {
        $query = AdminCompany::query()->with(['company', 'createdBy', 'updatedBy', 'deletedBy', 'restoredBy']);
    ...
    public function store(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'email' => [
                ...
                Rule::unique('admin_companies')->where('company_id', $request->company_id),
            ],
