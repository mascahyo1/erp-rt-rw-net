...
<template>
    ...
    <section class="min-h-[calc(100vh-200px)] flex overflow-x-hidden">
        <div class="flex-1 grid grid-cols-1 lg:grid-cols-2 min-w-0">
            <!-- Left: branded hero -->
            <div class="relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-700 flex items-center justify-center px-4 sm:px-6 py-16 lg:py-0 min-w-0">
