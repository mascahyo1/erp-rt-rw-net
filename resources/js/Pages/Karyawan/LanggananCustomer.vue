...
function openEdit(item) { editForm.defaults({ customer_id: item.customer_id, internet_package_id: item.internet_package_id, internet_status: item.internet_status, billing_cycle_start: item.billing_cycle_start, billing_cycle_end: item.billing_cycle_end, billing_amount: item.billing_amount }); editForm.reset(); selectedItem.value = item; showEditModal.value = true; }
