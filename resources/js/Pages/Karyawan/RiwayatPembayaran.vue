              ...
              >
                ...
                <td class="px-3 py-3" @click.stop>
                  <div class="flex items-center justify-center gap-1">
                    ...
                    <button v-if="can('karyawan-riwayat-pembayaran.edit') && !item.dihapus && item.status === 'pending'" @click="openEdit(item)" title="Edit" class="p-1.5 rounded-lg text-gray-400 hover:text-sky-600 hover:bg-sky-50 dark:hover:text-sky-400 dark:hover:bg-sky-900/30"><i class="fas fa-edit"></i></button>
                    <button v-if="can('karyawan-riwayat-pembayaran.persetujuan') && !item.dihapus && item.status === 'pending'" @click="openReview(item)" title="Review" class="p-1.5 rounded-lg text-gray-400 hover:text-amber-600 hover:bg-amber-50 dark:hover:text-amber-400 dark:hover:bg-amber-900/30"><i class="fas fa-clipboard-check"></i></button>
                    <button v-if="can('karyawan-riwayat-pembayaran.delete') && !item.dihapus" @click="openDelete(item)" title="Hapus" class="p-1.5 rounded-lg text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:text-red-400 dark:hover:bg-red-900/30"><i class="fas fa-trash-alt"></i></button>
