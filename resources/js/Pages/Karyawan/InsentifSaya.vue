...
const createForm = useForm({ emp_incentive_id: '', cust_internet_invcs_id: '', invoice_number: '', amount: '', date: '', reason: '', attachment: null });
  ...
  <div>
    ...
    <Teleport to="body"><Transition name="modal"><div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="showCreateModal = false"><div class="fixed inset-0 bg-black/50 backdrop-blur-sm"></div><form @submit.prevent="submitCreate" class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
      ...
      <div class="overflow-y-auto flex-1 px-6 py-5 space-y-4 modal-scroll">
        <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Kode Invoice <span class="text-red-500">*</span></label><input v-model="createForm.invoice_number" type="text" placeholder="Contoh: INV/2025/001" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /><p v-if="createForm.errors.invoice_number" class="text-red-500 text-xs mt-1">{{ createForm.errors.invoice_number }}</p></div>
        <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Insentif <span class="text-red-500">*</span></label><SearchableSelectAjax v-model="createForm.emp_incentive_id" url="/karyawan/api/search/incentives" placeholder="— Pilih Insentif —" /><p v-if="createForm.errors.emp_incentive_id" class="text-red-500 text-xs mt-1">{{ createForm.errors.emp_incentive_id }}</p></div>
        <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Invoice <span class="text-red-500">*</span></label><SearchableSelectAjax v-model="createForm.cust_internet_invcs_id" url="/karyawan/api/search/invoices" placeholder="— Pilih Invoice —" /><p v-if="createForm.errors.cust_internet_invcs_id" class="text-red-500 text-xs mt-1">{{ createForm.errors.cust_internet_invcs_id }}</p></div>
        <div class="grid grid-cols-2 gap-3">
          <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Jumlah <span class="text-red-500">*</span></label><input v-model="createForm.amount" type="number" placeholder="0" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /><p v-if="createForm.errors.amount" class="text-red-500 text-xs mt-1">{{ createForm.errors.amount }}</p></div>
          <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Tanggal <span class="text-red-500">*</span></label><input v-model="createForm.date" type="date" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /><p v-if="createForm.errors.date" class="text-red-500 text-xs mt-1">{{ createForm.errors.date }}</p></div>
        </div>
        <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Alasan Pengajuan</label><textarea v-model="createForm.reason" rows="2" placeholder="Jelaskan alasan pengajuan..." class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none resize-none"></textarea><p v-if="createForm.errors.reason" class="text-red-500 text-xs mt-1">{{ createForm.errors.reason }}</p></div>
    ...
    <Teleport to="body"><Transition name="modal"><div v-if="showEditModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="showEditModal = false"><div class="fixed inset-0 bg-black/50 backdrop-blur-sm"></div><form @submit.prevent="submitEdit" class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
      ...
      <div class="overflow-y-auto flex-1 px-6 py-5 space-y-4 modal-scroll">
        <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Kode Invoice <span class="text-red-500">*</span></label><input v-model="editForm.invoice_number" type="text" placeholder="Contoh: INV/2025/001" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /><p v-if="editForm.errors.invoice_number" class="text-red-500 text-xs mt-1">{{ editForm.errors.invoice_number }}</p></div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Jumlah <span class="text-red-500">*</span></label><input v-model="editForm.amount" type="number" placeholder="0" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /><p v-if="editForm.errors.amount" class="text-red-500 text-xs mt-1">{{ editForm.errors.amount }}</p></div>
          <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Tanggal <span class="text-red-500">*</span></label><input v-model="editForm.date" type="date" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /><p v-if="editForm.errors.date" class="text-red-500 text-xs mt-1">{{ editForm.errors.date }}</p></div>
        </div>
        <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Alasan Pengajuan</label><textarea v-model="editForm.reason" rows="2" placeholder="Jelaskan alasan pengajuan..." class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none resize-none"></textarea><p v-if="editForm.errors.reason" class="text-red-500 text-xs mt-1">{{ editForm.errors.reason }}</p></div>
