    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                <!-- Welcome Hero -->
                <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-sky-500 to-indigo-600 p-8 md:p-10 shadow-lg">
                    ...
                    <div class="relative flex flex-col md:flex-row items-start md:items-center gap-6">
                        <div class="w-16 h-16 rounded-2xl bg-white/15 backdrop-blur-sm flex items-center justify-center shrink-0">
                            <i class="fas fa-hand-wave text-white text-2xl"></i>
                        </div>
                        <div class="text-white">
                            <h3 class="text-2xl font-bold mb-1">Selamat datang, {{ $page.props.auth.user.name }}!</h3>
                            <p class="text-sky-100 text-sm md:text-base">Anda berhasil login. Dashboard ini akan menampilkan ringkasan bisnis RT/RW Net Anda.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-400">Total Pelanggan</div>
                    </div>
                    ...
                    <div class="rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">0</div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">Tagihan Bulan Ini</div>
                    </div>
                    ...
                    <div class="rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">Rp 0</div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">Pembayaran Masuk</div>
                    </div>
                    ...
                    <div class="rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">Rp 0</div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">Insentif Kolektor</div>
                    </div>
                </div>
            </div>
        </div>
