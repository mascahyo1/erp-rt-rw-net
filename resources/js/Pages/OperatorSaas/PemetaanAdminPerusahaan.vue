...
<template>
  <div>
    <Head title="Pemetaan Admin Perusahaan | Operator SaaS" />

    <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Pemetaan Admin Perusahaan</h2>
      <button class="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">
        <i class="fas fa-plus mr-1.5"></i> Tambah Pemetaan
      </button>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
      <div class="p-6">
        <p class="text-gray-500 dark:text-gray-400 text-center py-12">
          ...
          Belum ada data pemetaan admin perusahaan.
        </p>
      </div>
    </div>
    </div>
