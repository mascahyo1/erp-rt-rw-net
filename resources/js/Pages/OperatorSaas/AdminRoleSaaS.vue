...
<template>
  <div>
    ...
    <div class="flex items-center justify-between">
      <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Admin Role SaaS</h2>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
      <div class="p-6">
        <p class="text-gray-500 dark:text-gray-400 text-center py-12">
          <i class="fas fa-users-cog text-4xl mb-3 block"></i>
          Belum ada data admin role SaaS.
        </p>
      </div>
    </div>
    </div>
