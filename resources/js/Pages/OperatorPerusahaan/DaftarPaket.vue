...
const createForm = useForm({ name:'', price:'', speed_down_kbps:'', speed_up_kbps:'', quota_gb:'', billing_cycle:'monthly', is_unlimited:false, max_devices:'', fup_quota_down:'', fup_quota_up:'', fup_speed_down_kbps:'', fup_speed_up_kbps:'', description:'' });
const editForm = useForm({ name:'', price:'', speed_down_kbps:'', speed_up_kbps:'', quota_gb:'', billing_cycle:'', is_unlimited:false, max_devices:'', fup_quota_down:'', fup_quota_up:'', fup_speed_down_kbps:'', fup_speed_up_kbps:'', description:'' });
