...
function statusBadgeClass(s) { if (s === 'paid' || s === 'lunas') return 'bg-emerald-100 text-emerald-700 dark:!bg-emerald-900/30 dark:!text-emerald-300'; if (s === 'unpaid' || s === 'belum_bayar') return 'bg-amber-100 text-amber-700 dark:!bg-amber-900/30 dark:!text-amber-300'; return 'bg-red-100 text-red-700 dark:!bg-red-900/30 dark:!text-red-300'; }
