          ...
          <div class="flex items-center gap-2">
            ...
            <div class="relative">
              ...
              <Transition name="dropdown"><div v-show="profileDropdownOpen" class="absolute right-0 mt-2 w-48 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg py-1 z-50">
                ...
                <Link href="/karyawan/profil-saya" @click.stop="profileDropdownOpen = false" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"><i class="fas fa-user w-4 text-center"></i> Profil Saya</Link>
                <div class="border-t border-gray-100 dark:border-gray-700 my-1"></div>
                <Link href="/logout-karyawan" method="post" as="button" @click.stop="profileDropdownOpen = false" class="flex items-center gap-2 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors w-full text-left"><i class="fas fa-sign-out-alt w-4 text-center"></i> Logout</Link>
              </div></Transition>
            </div>
          </div>
        </div>
