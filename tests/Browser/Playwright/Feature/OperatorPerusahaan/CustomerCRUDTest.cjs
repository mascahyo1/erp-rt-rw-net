...
class CustomerCRUDTest {
    ...
    async runAllTests() {
        console.log('========================================');
        console.log('Customer CRUD Tests - Playwright');
        console.log('========================================\n');
        ...
        try {
            ...
            await this.helper.screenshot('OperatorPerusahaan/Customer/TestCRUD/XX-fatal');
        } finally {
    ...
    async safeTest(name, fn) {
        try {
            ...
            await this.helper.screenshot(`OperatorPerusahaan/Customer/TestCRUD/XX-${name.replace(/\s/g, '-')}`);
        }
    }
