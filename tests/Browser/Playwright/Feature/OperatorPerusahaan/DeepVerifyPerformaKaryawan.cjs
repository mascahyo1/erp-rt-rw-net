 ...
 * Ganti Performa Karyawan, ikuti 15 langkah checklist STANDARDS Â§7.3
 *
 * Cara pakai:
...
const RESULT_DIR = path.join(__dirname, '..', 'Feature', 'result', 'Feature', 'DeepVerifyPerformaKaryawan');
...
async function main() {
  ...
  // Performa Karyawan: pilih perusahaan via .fa-building jika diperlukan
  ...
  // Performa Karyawan: picks type, fill, waitForResponse, assert 200, screenshot
