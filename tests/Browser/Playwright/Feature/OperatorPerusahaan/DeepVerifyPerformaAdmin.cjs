 ...
 * Ganti Performa Admin, ikuti 15 langkah checklist STANDARDS Â§7.3
 *
 * Cara pakai:
...
const RESULT_DIR = path.join(__dirname, '..', 'Feature', 'result', 'Feature', 'DeepVerifyPerformaAdmin');
...
async function main() {
  ...
  // Performa Admin: pilih perusahaan via .fa-building jika diperlukan
  ...
  // Performa Admin: picks type, fill, waitForResponse, assert 200, screenshot
