 ...
 * Ganti Paket Tambah, ikuti 15 langkah checklist STANDARDS Â§7.3
 *
 * Cara pakai:
...
const RESULT_DIR = path.join(__dirname, '..', 'Feature', 'result', 'Feature', 'DeepVerifyPaketTambah');
...
async function main() {
  ...
  // Paket Tambah: pilih perusahaan via .fa-building jika diperlukan
  ...
  console.log('\n[2] Navigasi');
  await page.goto(`${BASE}/customer/paket-tambah`, { waitUntil: 'domcontentloaded' });
  ...
  // Paket Tambah: picks type, fill, waitForResponse, assert 200, screenshot
