 ...
 * Ganti Daftar Paket, ikuti 15 langkah checklist STANDARDS Â§7.3
 *
 * Cara pakai:
...
const RESULT_DIR = path.join(__dirname, '..', 'Feature', 'result', 'Feature', 'DeepVerifyDaftarPaket');
...
async function main() {
  ...
  // Daftar Paket: pilih perusahaan via .fa-building jika diperlukan
  ...
  console.log('\n[2] Navigasi');
  await page.goto(`${BASE}/customer/daftar-paket`, { waitUntil: 'domcontentloaded' });
  ...
  // Daftar Paket: picks type, fill, waitForResponse, assert 200, screenshot
