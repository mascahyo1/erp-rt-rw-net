...
class CustomerViewTest {
    ...
    async runAllTests() {
        console.log('========================================');
        console.log('Karyawan Customer View Tests - Playwright');
        console.log('========================================\n');
        ...
        try {
            ...
            await this.helper.screenshot('Karyawan/Customer/TestView/XX-fatal');
        } finally {
    ...
    async safeTest(name, fn) {
        try {
            ...
            await this.helper.screenshot(`Karyawan/Customer/TestView/XX-${name.replace(/\s/g, '-')}`);
        }
    }
...
const test = new CustomerViewTest();
