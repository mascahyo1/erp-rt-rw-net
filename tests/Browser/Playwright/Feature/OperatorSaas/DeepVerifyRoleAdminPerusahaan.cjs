 ...
 * Ganti Role Admin Perusahaan, ikuti 15 langkah checklist STANDARDS Â§7.3
 *
 * Cara pakai:
...
const RESULT_DIR = path.join(__dirname, '..', 'Feature', 'result', 'Feature', 'DeepVerifyRoleAdminPerusahaan');
...
async function main() {
  ...
  // Role Admin Perusahaan: pilih perusahaan via .fa-building jika diperlukan
  ...
  console.log('\n[2] Navigasi');
  await page.goto(`${BASE}/operator-saas/role-admin-perusahaan`, { waitUntil: 'domcontentloaded' });
  ...
  // Role Admin Perusahaan: picks type, fill, waitForResponse, assert 200, screenshot
