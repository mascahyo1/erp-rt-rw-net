 ...
 *
 * Module target: Insentif (insentif.{list,create,edit,detail,delete,restore})
 *
...
class InsentifPermissionTest extends DuskTestCase
{
    ...
    {
        $user = $this->createUserWithPerms(['insentif.list']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/dashboard')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/01-list/01-sidebar')
                ->assertSee('Dashboard')
                ->assertSee('Insentif')
                ->assertDontSee('Admin Perusahaan')
                ->assertDontSee('Karyawan');

            $browser->visit('/operator-perusahaan/insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/01-list/02-table');
            ...
            $browser->visit('/operator-perusahaan/insentif/create')
                ->pause(500)
                ->assertSee('403');
        });
    }
    ...
    {
        $user = $this->createUserWithPerms(['insentif.list', 'insentif.create']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/02-create/01-before');
            ...
            $browser->press('Tambah')
                ->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/02-create/02-modal')
    ...
    {
        $user = $this->createUserWithPerms(['insentif.list', 'insentif.edit']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/03-edit/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/03-edit/02-bulk-active');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/03-edit/03-modal')
    ...
    {
        $user = $this->createUserWithPerms(['insentif.list', 'insentif.detail']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/04-detail/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/04-detail/02-modal')
    ...
    {
        $user = $this->createUserWithPerms(['insentif.list', 'insentif.delete']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/05-delete/01-table');
            ...
            $browser->script("document.querySelectorAll('tbody input[type=\"checkbox\"]')[0].click()");
            $browser->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/05-delete/02-bulk-delete');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/05-delete/03-delete-modal')
    ...
    {
        $user = $this->createUserWithPerms(['insentif.list', 'insentif.restore']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/insentif?terhapus=ya&per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/insentif-permission/06-restore/01-trash-tab');
    ...
    public function test_07_no_perms_all_routes_forbidden(): void
    {
        ...
        $this->browse(function (Browser $browser) use ($user) {
            ...
            $browser->visit('/operator-perusahaan/dashboard')
                ->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/07-forbidden/01-sidebar-only-dashboard')
                ->assertSee('Dashboard')
                ->assertDontSee('Insentif')
                ->assertDontSee('Admin Perusahaan')
                ->assertDontSee('Karyawan');

            // Direct GET → 403
            $browser->visit('/operator-perusahaan/insentif')
                ->pause(500)
                ->screenshot('operator-perusahaan/insentif-permission/07-forbidden/02-get-forbidden')
                ->assertSee('403');
        });
    }
