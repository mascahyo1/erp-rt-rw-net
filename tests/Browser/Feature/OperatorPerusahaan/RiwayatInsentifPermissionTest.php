 ...
 *
 * Module target: Riwayat Insentif (riwayat-insentif.{list,create,edit,detail,delete,restore,persetujuan})
 *
 ...
 * | persetujuan | tombol approve ga muncul |
 */
class RiwayatInsentifPermissionTest extends DuskTestCase
{
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/dashboard')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/01-list/01-sidebar')
                ->assertSee('Dashboard')
                ->assertSee('Riwayat Insentif')
                ->assertDontSee('Admin Perusahaan')
                ->assertDontSee('Karyawan');

            $browser->visit('/operator-perusahaan/riwayat-insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/01-list/02-table');
            ...
            $browser->visit('/operator-perusahaan/riwayat-insentif/create')
                ->pause(500)
                ->assertSee('403');
        });
    }
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list', 'riwayat-insentif.create']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/02-create/01-before');
            ...
            $browser->press('Tambah')
                ->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/02-create/02-modal')
                ->assertSee('Tambah Riwayat Insentif');
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list', 'riwayat-insentif.edit']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/03-edit/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/03-edit/02-bulk-active');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/03-edit/03-modal')
                ->assertSee('Edit Riwayat Insentif');
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list', 'riwayat-insentif.detail']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/04-detail/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/04-detail/02-modal')
                ->assertSee('Detail Riwayat Insentif');
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list', 'riwayat-insentif.delete']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/05-delete/01-table');
            ...
            $browser->script("document.querySelectorAll('tbody input[type=\"checkbox\"]')[0].click()");
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/05-delete/02-bulk-delete');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/05-delete/03-delete-modal')
                ->assertSee('Hapus Riwayat Insentif?');
        });
    }
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list', 'riwayat-insentif.restore']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-insentif?terhapus=ya&per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/06-restore/01-trash-tab');
    ...
    public function test_07_no_perms_all_routes_forbidden(): void
    {
        ...
        $this->browse(function (Browser $browser) use ($user) {
            ...
            $browser->visit('/operator-perusahaan/dashboard')
                ->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/07-forbidden/01-sidebar-only-dashboard')
                ->assertSee('Dashboard')
                ->assertDontSee('Riwayat Insentif')
                ->assertDontSee('Admin Perusahaan')
                ->assertDontSee('Karyawan');

            // Direct GET → 403
            $browser->visit('/operator-perusahaan/riwayat-insentif')
                ->pause(500)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/07-forbidden/02-get-forbidden')
                ->assertSee('403');
        });
    }
    ...
    // LIST + PERSETUJUAN
    // ============================================================
    public function test_08_list_plus_persetujuan_shows_approve_button(): void
    {
        $user = $this->createUserWithPerms(['riwayat-insentif.list', 'riwayat-insentif.persetujuan']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-insentif?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-insentif-permission/08-persetujuan/01-table');
            ...
            $browser->assertPresent('button[title="Setujui"], a[title="Setujui"]');
        });
    }
