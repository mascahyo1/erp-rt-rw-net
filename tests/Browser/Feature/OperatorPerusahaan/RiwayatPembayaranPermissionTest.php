 ...
 *
 * Module target: Riwayat Pembayaran (riwayat-pembayaran.{list,create,edit,detail,delete,restore,persetujuan})
 *
 ...
 * | persetujuan | tombol approve/reject ga muncul |
 */
class RiwayatPembayaranPermissionTest extends DuskTestCase
{
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/dashboard')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/01-list/01-sidebar')
                ->assertSee('Dashboard')
                ->assertSee('Riwayat Pembayaran')
                ->assertDontSee('Admin Perusahaan')
                ->assertDontSee('Karyawan');

            $browser->visit('/operator-perusahaan/riwayat-pembayaran?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/01-list/02-table');
            ...
            $browser->visit('/operator-perusahaan/riwayat-pembayaran/create')
                ->pause(500)
                ->assertSee('403');
        });
    }
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list', 'riwayat-pembayaran.create']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-pembayaran?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/02-create/01-before');
            ...
            $browser->press('Tambah')
                ->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/02-create/02-modal')
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list', 'riwayat-pembayaran.edit']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-pembayaran?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/03-edit/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/03-edit/02-bulk-active');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/03-edit/03-modal')
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list', 'riwayat-pembayaran.detail']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-pembayaran?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/04-detail/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/04-detail/02-modal')
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list', 'riwayat-pembayaran.delete']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-pembayaran?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/05-delete/01-table');
            ...
            $browser->script("document.querySelectorAll('tbody input[type=\"checkbox\"]')[0].click()");
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/05-delete/02-bulk-delete');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/05-delete/03-delete-modal')
    ...
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list', 'riwayat-pembayaran.restore']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-pembayaran?terhapus=ya&per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/06-restore/01-trash-tab');
    ...
    public function test_07_no_perms_all_routes_forbidden(): void
    {
        ...
        $this->browse(function (Browser $browser) use ($user) {
            ...
            $browser->visit('/operator-perusahaan/dashboard')
                ->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/07-forbidden/01-sidebar-only-dashboard')
                ->assertSee('Dashboard')
            ...
            // Direct GET → 403
            $browser->visit('/operator-perusahaan/riwayat-pembayaran')
                ->pause(500)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/07-forbidden/02-get-forbidden')
                ->assertSee('403');
        });
    }
    ...
    // LIST + PERSETUJUAN
    // ============================================================
    public function test_08_list_plus_persetujuan_shows_approve_reject_buttons(): void
    {
        $user = $this->createUserWithPerms(['riwayat-pembayaran.list', 'riwayat-pembayaran.persetujuan']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/riwayat-pembayaran?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/riwayat-pembayaran-permission/08-persetujuan/01-table');
            ...
            $browser->assertPresent('button[title="Tolak"], a[title="Tolak"]');
        });
    }
