 ...
 *
 * Module target: Customer (customer.{list,create,edit,detail,delete,restore})
 *
...
class PermissionTest extends DuskTestCase
{
    ...
    private static array $cleanupCustomerIds = [];
    ...
    {
        $user = $this->createUserWithPerms(['customer.list']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/dashboard')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/01-list/01-sidebar')
                ->assertSee('Dashboard')
                ->assertSee('Customer')
                ->assertDontSee('Admin Perusahaan')
                ->assertDontSee('Karyawan');

            $browser->visit('/operator-perusahaan/customer?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/01-list/02-table');
            ...
            $browser->visit('/operator-perusahaan/customer/create')
                ->pause(500)
                ->assertSee('403');
        });
    }
    ...
    {
        $user = $this->createUserWithPerms(['customer.list', 'customer.create']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/customer?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/02-create/01-before');
            ...
            $browser->press('Tambah')
                ->pause(500)
                ->screenshot('operator-perusahaan/permission/02-create/02-modal')
    ...
    {
        $user = $this->createUserWithPerms(['customer.list', 'customer.edit']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/customer?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/03-edit/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/permission/03-edit/02-bulk-active');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/permission/03-edit/03-modal')
    ...
    {
        $user = $this->createUserWithPerms(['customer.list', 'customer.detail']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/customer?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/04-detail/01-table');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/permission/04-detail/02-modal')
    ...
    {
        $user = $this->createUserWithPerms(['customer.list', 'customer.delete']);

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/customer?per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/05-delete/01-table');
            ...
            $browser->script("document.querySelectorAll('tbody input[type=\"checkbox\"]')[0].click()");
            $browser->pause(500)
                ->screenshot('operator-perusahaan/permission/05-delete/02-bulk-delete');
            ...
            $browser->pause(500)
                ->screenshot('operator-perusahaan/permission/05-delete/03-delete-modal')
                ->assertSee('Hapus Pelanggan');
        });
    }
    ...
    {
        $user = $this->createUserWithPerms(['customer.list', 'customer.restore']);

        // Create + soft-delete a Customer so trash tab has data
        $trashCustomer = Customer::factory()->create([
            'name' => 'To Restore Pelanggan',
            'email' => 'torestore@rtrwnet.id',
            'is_active' => true,
        ]);
        $trashCustomer->delete();
        self::$cleanupCustomerIds[] = $trashCustomer->id;

        $this->browse(function (Browser $browser) use ($user) {
            $browser->loginAs($user, 'admin-company')
                ->visit('/operator-perusahaan/customer?terhapus=ya&per_page=100')
                ->pause(800)
                ->screenshot('operator-perusahaan/permission/06-restore/01-trash-tab');
            ...
            $browser->script("document.querySelectorAll('tbody input[type=\"checkbox\"]')[0].click()");
            $browser->pause(500)
                ->screenshot('operator-perusahaan/permission/06-restore/02-bulk-restore');
    ...
    public function test_07_no_perms_all_routes_forbidden(): void
    {
        ...
        $this->browse(function (Browser $browser) use ($user) {
            ...
            $browser->visit('/operator-perusahaan/dashboard')
                ->pause(500)
                ->screenshot('operator-perusahaan/permission/07-forbidden/01-sidebar-only-dashboard')
                ->assertSee('Dashboard')
            ...
            // Direct GET → 403
            $browser->visit('/operator-perusahaan/customer')
                ->pause(500)
                ->screenshot('operator-perusahaan/permission/07-forbidden/02-get-forbidden')
                ->assertSee('403');
        });
    }
    ...
    {
        Customer::whereIn('id', self::$cleanupCustomerIds)->forceDelete();
